...
class UserPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'active_status', 'user', 'region', 'city', 'views_count', 'update_count', 'created_at', 'updated_at', 'car')
    ...
    def update(self, instance, validated_data):
        data = dict(validated_data.get("car"))
        ...
        car = CarModel.objects.update(**data)
        instance.save()
        return instance
